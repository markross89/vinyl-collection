              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="p-5">
                    ...
                    <div>
                      <p class="lead text-gray-800 mb-5">It looks like we already have this email</p>
                      <p class="text-gray-500 mb-0">
                        Try to login, or use different email
                      </p>
                      <a href="<c:url value="/user/register"/>">&larr; back</a>
                    </div>
                    </div>
                  </div>
